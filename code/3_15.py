...
X_train, X_test, Y_train, Y_test = np.load('H:/1. Research/3. PoDoc_Kim/1. CoCr_AI design/2. Python Code/n_comp_n_hatch_CODE_NPY/3_15.npy', allow_pickle = True)
print(X_train.shape)
...
model.save('H:/1. Research/3. PoDoc_Kim/1. CoCr_AI design/2. Python Code/model/3_15.h5', overwrite=True)
...
ax.set_title('3_comp_15_hatching');
